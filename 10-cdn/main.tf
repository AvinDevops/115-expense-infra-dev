...
resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              = "web-${var.environment}.${var.zone_name}" #web-dev.aviexpense.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"] #web-cdn.aviexpense.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-${var.common_tags.Component}" #web-cdn.aviexpense.online
      type    = "A"
